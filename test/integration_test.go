...
func TestApplySkipTrue(t *testing.T) {
	...
	cleanupTerragruntFolder(t, TEST_FIXTURE_SKIP)
	cleanupTerragruntFolder(t, util.JoinPath(TEST_FIXTURE_SKIP, "skip-true"))
	rootPath := util.JoinPath(TEST_FIXTURE_SKIP, "skip-true")
...
func TestApplySkipFalse(t *testing.T) {
	...
	cleanupTerragruntFolder(t, TEST_FIXTURE_SKIP)
	cleanupTerragruntFolder(t, util.JoinPath(TEST_FIXTURE_SKIP, "skip-false"))
	rootPath := util.JoinPath(TEST_FIXTURE_SKIP, "skip-false")
...
func TestApplyAllSkipTrue(t *testing.T) {
	...
	cleanupTerragruntFolder(t, TEST_FIXTURE_SKIP)
	cleanupTerragruntFolder(t, util.JoinPath(TEST_FIXTURE_SKIP, "skip-true"))
	cleanupTerragruntFolder(t, util.JoinPath(TEST_FIXTURE_SKIP, "skip-true", "resource1"))
	cleanupTerragruntFolder(t, util.JoinPath(TEST_FIXTURE_SKIP, "skip-true", "resource2"))
	rootPath := util.JoinPath(TEST_FIXTURE_SKIP, "skip-true")
...
func TestApplyAllSkipFalse(t *testing.T) {
	...
	cleanupTerragruntFolder(t, TEST_FIXTURE_SKIP)
	cleanupTerragruntFolder(t, util.JoinPath(TEST_FIXTURE_SKIP, "skip-false"))
	cleanupTerragruntFolder(t, util.JoinPath(TEST_FIXTURE_SKIP, "skip-false", "resource1"))
	cleanupTerragruntFolder(t, util.JoinPath(TEST_FIXTURE_SKIP, "skip-false", "resource2"))
	rootPath := util.JoinPath(TEST_FIXTURE_SKIP, "skip-false")
